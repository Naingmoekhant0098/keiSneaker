  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        setData(null);
        setImages(null);
        clearRef.current.clearValue();
      }
    } catch (error) {}
  };

  return (
    <div className="py-2 md:p-4 md:-ml-8 mt-14 w-full  ">
      <div className=" mb-10">
      ...
      <div className=" text-xl font-medium text-center mb-10">
        Create New Product
      </div>
      <form
        action=""
      ...
      >
       ...
       <div className=" mb-3 flex-1">
        ...
        <div className=" flex-1 mb-3">
          <Label>Product Inventary</Label>
          <TextInput
            type="number"
            required
            className=" mt-2"
            placeholder="Product Inventary"
            onChange={(e) => setData({ ...data, itemsQty: e.target.value })}
          />
        </div>
       </div>
        <div className=" mb-3">
